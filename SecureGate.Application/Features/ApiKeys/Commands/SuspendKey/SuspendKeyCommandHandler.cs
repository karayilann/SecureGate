...
public class SuspendKeyCommandHandler : IRequestHandler<SuspendKeyCommand, ApiKeyDto?>
{
    ...
    public SuspendKeyCommandHandler(
    ...
    public async Task<ApiKeyDto?> Handle(SuspendKeyCommand request, CancellationToken cancellationToken)
    {
